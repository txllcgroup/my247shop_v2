                ...
                >
                  ...
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-2">
                       <span className="text-black font-bold text-lg">NGN {(customer as any).totalSpent?.toLocaleString() || '0'}</span>
                   ...
                   <div className="bg-white p-8 rounded-[2rem] border-2 border-gray-100 space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                         <div>
                            ...
                            <p className="font-bold text-black text-2xl">NGN {((selectedCustomer as any).totalSpent || 0).toLocaleString()}</p>
                         </div>
                         <div>
