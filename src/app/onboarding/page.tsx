...
const Step1Account = ({ formData, updateAccount }: any) => (
  ...
  >
    ...
    <button className="flex items-center justify-center gap-3 w-full border-2 border-black rounded-2xl p-5 font-semibold text-lg text-black hover:bg-gray-50 transition-colors">
